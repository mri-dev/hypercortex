...
<?php
  ...
  $icoimg = get_stylesheet_directory() . '/images/ico/ico-'.$slug.'.svg';
  if (!file_exists($icoimg)) {
    $icoimg = '';
  } else {
    $icoimg = '<img class="ico" src="'.IMG.'/ico/ico-'.$slug.'.svg" alt="" />';
  }
?>
<?php echo do_shortcode('[szolgaltatas-block view="big" autopageparent="1"]'); ?>
<div class="page-custom-title fake-arrow-down arrow-down-lightbrown">
  <h1><?php echo $icoimg; ?><?php the_title(); ?></h1>
</div>
