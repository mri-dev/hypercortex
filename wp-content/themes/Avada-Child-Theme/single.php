...
if ($cat_data) {
  $post_nav_info .= '<span class="incat"><a href="'.get_category_link($cat_data).'">'.$cat_data->name.'</a></span>';
}
...
if ($tags) {
  ...
  foreach ((array)$tags as $t) {
    $taglines .= '<span class="tag"><a href="/tag/'.$t->slug.'">#'.($t->name).'</a></span> ';
  }
	...
	<div class="single-post-wrapper">
	  <section id="content" <?php Avada()->layout->add_style( 'content_style' ); ?>>
	  	...
	  	<?php while ( have_posts() ) : ?>
	        ...
	        <?php if ($post_nav_info): ?>
	        <div class="post-nav-info"><?php echo $post_nav_info; ?></div>
	        <?php endif; ?>
	  			<?php $full_image = ''; ?>
