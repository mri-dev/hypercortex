...
class CalculatorBase
{
  ...
  public $year_version = '2023';
  public $avaiable_versions = array('2023', '2022', '2021','2020/2', '2020/1', '2019');  
  ...
  function calc_settings_cb()
  {
    ...
    $settings[] = $this->getVersion(true).'adokedvezmeny_csalad_beteg_gyermek';
  ...
  public function getSettingsValue( $key )
  {
    ...
    $res['adokedvezmeny_csalad_beteg_gyermek'] = (float)$this->get_option($this->getVersion(true).'adokedvezmeny_csalad_beteg_gyermek', 0 );
  ...
  private function load_berkalkulator_resources()
  {
    ...
    $res['adokedvezmeny_csalad_gyermek2'] = $this->getSettingsValue('adokedvezmeny_csalad_gyermek2');
    $res['adokedvezmeny_csalad_gyermek3'] = $this->getSettingsValue('adokedvezmeny_csalad_gyermek3');
    $res['adokedvezmeny_csalad_beteg_gyermek'] = $this->getSettingsValue('adokedvezmeny_csalad_beteg_gyermek');
...
************************************************/
class CalculatorV2022 extends CalculatorBase implements CalculatorVersion
{
  /** 25 év alattiaknak az adóalap limit eddig adómentesek */
  public $ado_ev25alatti_limit = 433700;
  ...
  public function getCafeteriaItemAdoalapLimit()
  {
    ...
    $limits['Sportrendezvényre szóló belépőjegy, bérlet'] = 200000;
    $limits['Kulturális szolgáltatásra szóló belépőjegy, bérlet'] = 200000;    
    //$limits['Távmunkavégzés költségtérítése'] = 16740;
    $limits['Csekély értékű ajándék'] = 20000;
...
/***********************************************
* 2023-es jogszabályoknak megfelelő kalkulátor @since 2023-07-20 *
************************************************/
class CalculatorV2023 extends CalculatorBase implements CalculatorVersion
{
  /** 25 év alattiaknak az adóalap limit eddig adómentesek */
  public $ado_ev25alatti_limit = 499952;
    ...
    switch ( $calc )
    {
      case 'berkalkulator':
        ...
        switch( $mode )
        {
          // Nettó bérkalkulátor
          case 'netto':
            $brutto_ber = (float)$jovedelem;
          break;
          // Bruttó bérkalkulátor
          case 'brutto':
            $data['netto_ber'] = (float)$jovedelem;
          break;
          // Teljes bérkalkulátor
          case 'teljes':
            $brutto_ber = (float)$jovedelem;
        ...
        if( $mode != 'brutto' )
        {
          ...
          // Beteg gyermek extra kedvezmény
          if( (int)$data['csalad_eltartott_beteg_gyermek_kedvezmenyezett'] > 0 )
          {
            $beteg_each = (float)$settings['adokedvezmeny_csalad_beteg_gyermek'];
            $calced_csk_beteg_gyerek = $beteg_each * (int)$data['csalad_eltartott_beteg_gyermek_kedvezmenyezett'];

            if( $calced_csk_beteg_gyerek > 0 )
            {
              $csaladi_adokedvezmeny_osszege += $calced_csk_beteg_gyerek;
            }
          }
          ...
          if( $data['kor25ev_alatti'] == 'Igen' )
          {
           ...
           /** 30 év alatti anya -> adómentesség */
           // kor30ev_alatti_anya == "ado_ev25alatti_limit" megegyezik
           if( $data['kor30ev_alatti_anya'] == 'Igen' )
           {
              if( $data['kor25ev_alatti'] == 'Nem' )
              {
                $prev_brutto_ber = $brutto_ber;
              } else {
                $brutto_ber = $prev_brutto_ber;
              ...
              $ret['calced_30evalatti_brutto'] = $brutto_ber;
           }
  
           $ret['test'] = $prev_brutto_ber;

          // Maradék családi kedvezmény alap
          if ( !$anyak_gyerek4vagytobb )
          {
            $csaladi_adokedvezmeny_maradekalap = $csaladi_adokedvezmeny_osszege+$friss_hazasok_kedvezmeny+$szemelyi_kedvezmeny-$prev_brutto_ber;
            $csaladi_adokedvezmeny_maradekalap = ($csaladi_adokedvezmeny_maradekalap < 0) ? 0 : $csaladi_adokedvezmeny_maradekalap;
          } else {
            $csaladi_adokedvezmeny_maradekalap = $csaladi_adokedvezmeny_osszege;
            $csaladi_adokedvezmeny_maradekalap = ($csaladi_adokedvezmeny_maradekalap < 0) ? 0 : $csaladi_adokedvezmeny_maradekalap;
          ...
          // RESET : 25 év alatti munkavállaló vagy 30 év alatti anya bruttó alap módosítás -> adómentesség
          if( $data['kor25ev_alatti'] == 'Igen' ||  $data['kor30ev_alatti_anya'] == 'Igen')
          {
            $brutto_ber = $prev_brutto_ber;
          }
