<div class="wrapper">
  <div class="inputs">
    ...
    <div class="inp-body">
      ...
      <div ng-if="form.mode && ['2022','2023'].indexOf(form.version) !== -1" class="line" ng-class="{missing:missing.indexOf('kor25ev_alatti')!==-1, error:error_elements['kor25ev_alatti']}">
        <div class="head">
      ...
      <div ng-if="form.mode && ['2023'].indexOf(form.version) !== -1" class="line" ng-class="{missing:missing.indexOf('kor30ev_alatti_anya')!==-1, error:error_elements['kor30ev_alatti_anya']}">
        <div class="head">
          A munkavállaló 30 év alatti anya?
          <div class="error-hint" ng-if="error_elements.indexOf('kor30ev_alatti_anya')!==-1">{{error_elements['kor30ev_alatti_anya']}}</div>
        </div>
        <div class="val">
          <div class="inp-wrapper select-wrapper">
            <select class="" ng-model="form.kor30ev_alatti_anya" ng-options="item for item in settings.select_yesno"></select>
          </div>
        </div>
      </div>
      ...
      <div class="line" ng-if="form.csaladkedvezmenyre_jogosult=='Igen' && ['2023'].indexOf(form.version) !== -1" ng-class="{missing:missing.indexOf('csalad_eltartott_beteg_gyermek_kedvezmenyezett')!==-1, error:error_elements['csalad_eltartott_beteg_gyermek_kedvezmenyezett']}">
        <div class="head">
          - Kedvezményezett beteg gyermekek száma *
          <div class="error-hint" ng-if="error_elements.indexOf('csalad_eltartott_beteg_gyermek_kedvezmenyezett')!==-1">{{error_elements['csalad_eltartott_beteg_gyermek_kedvezmenyezett']}}</div>
        </div>
        <div class="val">
          <div class="inp-wrapper select-wrapper">
            <select class="" ng-model="form.csalad_eltartott_beteg_gyermek_kedvezmenyezett" ng-options="n for n in [] | range:0:6"></select>
          </div>
        </div>
      </div>
