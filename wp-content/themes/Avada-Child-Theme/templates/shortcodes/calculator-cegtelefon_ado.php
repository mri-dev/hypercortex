<div class="wrapper">
  <div class="inputs">
    <div class="header">Cégtelefon adó kalkulátor</div>
    <div class="inp-body">
      ...
      <div class="line" ng-class="{missing:missing.indexOf('szamla_brutto')!==-1, error:error_elements['szamla_brutto']}">
        <div class="head">
          Számla cégtelefon köteles bruttó értéke *
  ...
  <div class="result-view">
    ...
    <div class="result-jog-text">{{result.result_comment}}</div>
      <table class="result-table">
        <tbody>
          <tr>
            <td class="h"><strong>Számla cégtelefon köteles bruttó értéke</strong></td>
